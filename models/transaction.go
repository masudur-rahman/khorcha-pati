...
var subKeywords = map[string]string{
	...
	"fin-repay": "emi, installment, loan payment", "fin-lend": "lend, gave loan, dhar dilam",
	"fin-recover": "recover, got back, they paid", "fin-borrow": "borrow, took money, dhar nilam",
	"fin-return": "return, payback, gave back, dhar shodh", "fin-tax": "tax, vat, income tax",
