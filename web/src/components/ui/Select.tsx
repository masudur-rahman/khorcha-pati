...
export default function Select({ label, options, error, style, disabled, ...props }: SelectProps) {
  return (
    <label style={{ display: 'flex', flexDirection: 'column', gap: 6, width: '100%' }}>
      <span style={{
        ...
        color: disabled ? 'var(--color-text-tertiary)' : 'var(--color-text-tertiary)',
      ...
      <div style={{ position: 'relative' }}>
        <select
          ...
          style={{
            width: '100%',
            background: disabled ? 'var(--color-hover)' : 'var(--color-bg)',
